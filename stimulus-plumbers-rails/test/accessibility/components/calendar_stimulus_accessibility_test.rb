...
class CalendarStimulusAccessibilityTest < ApplicationAccessibilityTestCase
  ...
  def test_passes_wcag_with_default_month
    visit "/components/calendar/stimulus"
  ...
  def test_passes_wcag_for_28_cell_grid
    ...
    visit "/components/calendar/stimulus?year=2026&month=2"
  ...
  def test_passes_wcag_for_42_cell_grid
    ...
    visit "/components/calendar/stimulus?year=2023&month=7"

    assert_accessible context: "#calendar"
  end

  def test_passes_wcag_with_other_months_visible
    visit "/components/calendar/stimulus?year=2026&month=4&show_other_months=true"
  ...
  def test_passes_wcag_with_date_range
    ...
    visit "/components/calendar/stimulus?year=2026&month=4&since=2026-03-30&till=2026-04-20"

    assert_accessible context: "#calendar"
  end

  def test_passes_wcag_with_date_range_and_other_months_visible
    visit "/components/calendar/stimulus?year=2026&month=4&since=2026-03-30&till=2026-04-20&show_other_months=true"

    assert_accessible context: "#calendar"
  end

  def test_passes_wcag_with_selected_date
    visit "/components/calendar/stimulus?year=2026&month=6"
