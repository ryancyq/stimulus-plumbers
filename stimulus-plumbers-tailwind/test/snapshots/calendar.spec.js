...
test.describe("turbo calendar", () => {
  ...
  test("selectable", async ({ page }) => {
    ...
    await page.waitForSelector("[role='grid']");
    await expect(page.locator("#calendar")).toHaveScreenshot("turbo-selectable.png");
  });
  ...
  test("other months visible", async ({ page }) => {
    ...
    await page.waitForSelector("[role='grid']");
    await expect(page.locator("#calendar")).toHaveScreenshot("turbo-other-months.png");
  });
  ...
  test("selectable with other months visible", async ({ page }) => {
    ...
    await page.waitForSelector("[role='grid']");
    await expect(page.locator("#calendar")).toHaveScreenshot("turbo-selectable-other-months.png");
  });
});
