...
class StimulusPlumbersTailwind::InstallGeneratorTest < Rails::Generators::TestCase
  ...
  GEM_LIB_GLOB  = "#{Gem.loaded_specs[GEM_NAME].gem_dir}/lib/**/*.rb"
  SOURCE_LINE   = %(@source "#{GEM_LIB_GLOB}";)
